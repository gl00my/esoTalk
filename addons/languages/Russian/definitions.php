...
$definitions["a private conversation"] = "личное обсуждение";
...
$definitions["Email me when I'm added to a private conversation"] = "Сообщить письмом, если меня добавили в личное обсуждение";
...
$definitions["label.private"] = "Личное";
...
$definitions["message.conversationNotFound"] = "Это обсуждение не может быть просмотрено. Уж не удалено ли оно? А может это личное обсуждение, а вы не вошли на форум или не имеете права его просмотра.";
...
$definitions["Email me when someone posts in a conversation I have followed"] = "Сообщать письмом, когда кто-то написал в теме, за которой я слежу";
$definitions["Email me when there is a new post by a member I have followed"] = "Сообщить письмом, при сообщениях от участника, за которым я слежу";
$definitions["Email me when someone posts in a channel I have followed"] = "Сообщить письмом, когда кто-то написал в канале, за которым я слежу";
$definitions["Email me when someone mentions me in a post"] = "Сообщать письмом, при упоминании меня в сообщениях";
$definitions["Automatically follow conversations that I reply to"] = "Автоматически следить за темами, в которых я отвечаю";
